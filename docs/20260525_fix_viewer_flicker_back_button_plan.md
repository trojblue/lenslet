...
The next operator should start with Sprint 3 / FBB-7, then keep this document current as work proceeds. Do not mark a sprint complete unless its browser acceptance gate passes on the gallery-to-viewer path. If this plan is revised, add a brief note here explaining what changed and why.
