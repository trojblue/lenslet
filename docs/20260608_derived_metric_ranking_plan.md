...
Next operator should start with Sprint 4, Atomic Persistence and Invalid-State UX. Do not begin Metrics Panel UI work until atomic persistence, Smart Folder retention, and unavailable-derived warnings are covered by tests.
