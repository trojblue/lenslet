...
Next operator should start with Sprint 3, Derived Metric Model and Evaluation. Do not begin Metrics Panel UI work until the pure derived model/evaluator and AppShell wiring are covered by tests.
