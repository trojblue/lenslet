...
Sprint 2 completed checks on 2026-03-08:
    ...
    from lenslet.storage.table_launch import prepare_table_launch
    ...
    launch_result = prepare_table_launch(parquet_path=parquet_path, base_dir=None, source_column=None, cache_wh=False, skip_indexing=True, auto_detect_root=True)
