...
import FilterBuilder from '../filters/FilterBuilder/FilterBuilder'
  ...
  return (
    <div className="h-full flex flex-col gap-3 p-3 overflow-auto scrollbar-thin">
      <div className="space-y-2">
        <div className="text-[11px] uppercase tracking-wide text-muted">Filters</div>
        <FilterBuilder
          filters={filters}
      ...
      {!metricKeys.length ? (
        <div className="p-4 text-sm text-muted">No metrics found in this dataset.</div>
      ) : (
