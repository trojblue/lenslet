...
export type Sidecar = { v: 1; tags: string[]; notes: string; exif?: { width?: number; height?: number; created_at?: string }; hash?: string; original_position?: string; updated_at: string; updated_by: string }
