...
export type Item = { path: string; name: string; type: Mime; w: number; h: number; size: number; hasThumb: boolean; hasMeta: boolean; hash?: string; addedAt?: string | null; star?: number | null }
