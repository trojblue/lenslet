...
from scripts.browser.gui_smoke.fixtures import build_derived_metric_table_fixture, build_fixture_dataset
    ...
    return {
        ...
        "checks": {
            ...
            "derived_metric_ranking": None if derived_metric_result is None else {
                ...
                "top_path_after_rank": derived_metric_result.top_path_after_rank,
                "top_path_after_reload": derived_metric_result.top_path_after_reload,
                "top_path_after_smart_folder_restore": derived_metric_result.top_path_after_smart_folder_restore,
                "partial_warning": derived_metric_result.partial_warning,
