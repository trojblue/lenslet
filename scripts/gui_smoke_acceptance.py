...
def run_left_panel_scenario(page: Page) -> LeftPanelScenarioResult:
    ...
    page.wait_for_timeout(150)
    collapsed_state = left_panel_state(page)
    ...
    page.wait_for_timeout(150)
    active_tab_open_state = left_panel_state(page)
    ...
    page.get_by_role("button", name="Folders").click()
    page.wait_for_timeout(150)
    active_tab_collapsed_state = left_panel_state(page)
    ...
    page.wait_for_timeout(150)
    hotkey_reopen_state = left_panel_state(page)
...
def run_anchor_and_search_scenario(
    ...
    search_visible_matches = [value for value in raw_matches if isinstance(value, str)]
