...
from lenslet.server import DatasetAppOptions, StorageAppOptions, create_app_from_datasets, create_app_from_storage
...
def _build_table_app(
    ...
    return create_app_from_storage(
        storage,
        options=StorageAppOptions(show_source=include_source_in_search),
    )
...
def _build_dataset_app(
    ...
    return create_app_from_datasets(datasets, options=DatasetAppOptions(show_source=include_source_in_search))
