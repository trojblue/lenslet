...
from lenslet.server import LocalAppOptions, create_app
from lenslet.storage.memory import MemoryStorage
from lenslet.web.media import file_response
...
def test_file_response_uses_streaming_when_local_source_path_exists(tmp_path: Path) -> None:
    ...
    response = file_response(storage, "/logical/sample.jpg")
...
def test_file_response_falls_back_for_non_local_sources() -> None:
    ...
    response = file_response(storage, "/logical/remote.jpg")
...
def test_file_response_falls_back_when_local_resolver_rejects_path() -> None:
    ...
    response = file_response(storage, "../secret.jpg")
